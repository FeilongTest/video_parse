...
class AppColors {
  ...
  /// 主控件-背景 蓝色
  static const Color primaryElement = Color.fromARGB(255, 111, 44, 255);

  static const Color secendPrimaryElement = Color(0xFFEADDFF);
  ...
  /// 第二种控件-文本 浅蓝色
  static const Color secondaryElementText = Color.fromARGB(255, 111, 44, 255);
